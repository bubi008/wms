                ...
                <div class="container-fluid">
                    <div class="card easion-card">
                        <div class="card-header">
                            ...
                            <div class="easion-card-title"> Input Rincian Koreksi UJL Karena Wanprestasi</div>
                        </div>
                        <div class="card-body">
                            <form action="rphl/input_data" method="post">
                                ...
                                <div class="form-group">                                    
                                    ...
                                    <select class="col-sm-4" name="jenis_penerimaan[]" id="nama_jenis" class="form-control">
                                                    ...
                                                    <option value="Bea Lelang Wanprestasi">Bea Lelang Wanprestasi</option>
                                                     <option value="Hak Penjual">Hak Penjual</option>
